...
/*   Updated: 2016/04/11 17:22:44 by tgauvrit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				Bureaucrat::signForm( Form & f ) const {
	try { f.beSigned(*this); }
		...
		std::cout << this->_name << " cannot sign the " << f.getName() << " Form because their " << e.what() << "." << std::endl;
		return;
	}
	std::cout << this->_name << " signs the " << f.getName() << " Form." << std::endl;
}
